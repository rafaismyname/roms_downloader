...
class TitleMetadataParser {
  ...
  static final List<_PatternHandler> _patterns = [
    ...
    _PatternHandler(RegExp(r'\(Not for Resale\)'), (match, context) => context.distributionTypes.add(DistributionType.alternate)),
    _PatternHandler(RegExp(r'\(Intellivision Lives!\)'), (match, context) => context.distributionTypes.add(DistributionType.alternate)),
    _PatternHandler(RegExp(r'\(Alt\)'), (match, context) => context.distributionTypes.add(DistributionType.alternate)),
    ...
    _PatternHandler(RegExp(r'\(Arcade CD-ROM\)'), (match, context) { context.distributionTypes.add(DistributionType.alternate); context.categories.add('Arcade'); }),
